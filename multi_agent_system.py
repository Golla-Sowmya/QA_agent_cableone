...
class MultiAgentRAGSystem:
    ...
    def _load_test_cases(self):
        ...
        if not txt_files:
            print(f"⚠️  No .txt files found in {self.test_cases_dir}")
            return
    ...
    async def generate_test_cases(self, user_story: str, additional_requirements: str = "", 
        ...
        for i, req in enumerate(requirements, 1):
            ...
            if len(existing_cases) >= req.count_needed:
                ...
                print(f"   ✅ Retrieval Complete: Found {len(selected)} existing test case(s)")
                ...
                if existing_cases:
                    ...
                    print(f"   ✅ Retrieval Partial: Found {len(existing_cases)} existing test case(s)")
                ...
                for j in range(missing_count):
                    print(f"   🛠️  Generating test case {j+1}/{missing_count}...")
        ...
        print(f"   📋 Total Delivered: {len(formatted_cases)}")
